...
const ResellerPayments = () => {
  ...
  const handleApprove = (id: string) => {
    ...
    addExpense({
      id: 'exp-reseller-' + Date.now(),
      title: `রিসেলার পেমেন্ট - ${req.resellerName}`,
      category: 'রিসেলার পেমেন্ট',
      amount: req.amount,
      note: `${methodLabels[req.method] || req.method} - ${req.accountNumber}`,
      date: new Date().toISOString(),
    });
    toast.success(`৳${req.amount} পেমেন্ট অনুমোদিত হয়েছে এবং খরচে যুক্ত হয়েছে`);
  };
