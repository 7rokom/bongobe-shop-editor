...
import { Plus, Edit2, Eye, EyeOff, KeyRound } from 'lucide-react';
...
const AllResellers = () => {
  ...
  const handleDeactivate = () => {
    if (deactivateId) {
      updateReseller(deactivateId, { isActive: false, deactivationNote: deactivateNote });
  ...
  const handleActivate = (id: string) => {
    updateReseller(id, { isActive: true, deactivationNote: '' });
