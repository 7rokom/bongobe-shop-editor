...
const ResellerPaymentMethods = () => {
  ...
  const fetchMethods = async () => {
    const { data } = await db.from('reseller_payment_methods').select('*').eq('reseller_id', resellerId);
  ...
  const handleAdd = async () => {
    ...
    const { error } = await db.from('reseller_payment_methods').insert({
      id,
  ...
  const handleDelete = async (id: string) => {
    await db.from('reseller_payment_methods').delete().eq('id', id);
