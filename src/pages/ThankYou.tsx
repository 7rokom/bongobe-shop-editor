...
const ThankYou = () => {
  ...
  const { phone } = useSiteSettingsStore();
      ...
      <div className="max-w-lg mx-auto">
        <div className="bg-card overflow-hidden">
          ...
          <div className="px-6 py-6 space-y-5">
            ...
            {/* Info */}
            <div className="bg-muted/50 rounded-[5px] p-4 text-center">
              ...
              {phone && (
                <a
                  href={`tel:${phone}`}
                  className="inline-flex items-center gap-1.5 text-[16px] text-primary font-medium mt-2 hover:underline"
                >
